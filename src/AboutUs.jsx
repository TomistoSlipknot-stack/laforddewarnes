  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '30px 20px' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 30 }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 800, color: t.text || '#1a1a1a', margin: '0 0 8px' }}>La Ford de Warnes</h1>
        <p style={{ fontSize: 16, color: t.textSecondary || '#666', lineHeight: 1.6 }}>
      ...
      <div style={{ background: t.card || '#fff', border: '1px solid ' + (t.cardBorder || '#e0e0e0'), borderRadius: 12, padding: 24, marginBottom: 20 }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, color: '#003478', marginBottom: 12 }}>Nuestra Historia</h2>
        <p style={{ fontSize: 14, color: t.textSecondary || '#555', lineHeight: 1.8 }}>
        ...
        <p style={{ fontSize: 14, color: t.textSecondary || '#555', lineHeight: 1.8, marginTop: 10 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 14, marginBottom: 20 }}>
        {[
          ...
          <div key={i} style={{ background: t.card || '#fff', border: '1px solid ' + (t.cardBorder || '#e0e0e0'), borderRadius: 10, padding: 18, textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 14, fontWeight: 700, color: t.text || '#333', marginBottom: 4 }}>{s.title}</div>
      ...
      {/* Contact */}
      <div style={{ background: t.card || '#fff', border: '1px solid ' + (t.cardBorder || '#e0e0e0'), borderRadius: 12, padding: 24, marginBottom: 20 }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, color: '#003478', marginBottom: 12 }}>Encontranos</h2>
        <div style={{ fontSize: 14, color: t.textSecondary || '#555', lineHeight: 2 }}>
      ...
      <div style={{ borderRadius: 12, overflow: 'hidden', border: '1px solid ' + (t.cardBorder || '#e0e0e0') }}>
        <iframe
          ...
          width="100%" height="250" style={{ border: 0 }} allowFullScreen="" loading="lazy" title="Ubicacion"
        />
      </div>
    </div>
  );
